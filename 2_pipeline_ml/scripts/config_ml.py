...
# Répertoire des données d'entrée (Phase 1)
DATA_INPUT_DIR = PROJECT_ROOT / "1_data_prep" / "input"

# Répertoire de sortie Phase 1
DATA_PREP_OUTPUT_DIR = PROJECT_ROOT / "1_data_prep" / "output"

# Répertoire Phase 2 (ML Pipeline)
ML_ROOT = PROJECT_ROOT / "2_pipeline_ml"

# Répertoire des scripts ML
SCRIPTS_DIR = ML_ROOT / "scripts"

# Répertoire des données intermédiaires ML
DATA_INTERMEDIATE_DIR = ML_ROOT / "output"

# Répertoire des résultats finaux (output Phase 1)
DATA_OUTPUT_DIR = DATA_PREP_OUTPUT_DIR

# Répertoire des modèles entraînés
MODELS_DIR = DATA_INTERMEDIATE_DIR / "4_modeles"

# Répertoire des rapports et graphiques
REPORTS_DIR = DATA_INTERMEDIATE_DIR / "5_rapports"
...
INPUT_FILES = {
    'pharmacies': DATA_PREP_OUTPUT_DIR / 'pharmacies_final.csv',
    'hubs': DATA_PREP_OUTPUT_DIR / 'HUBS_unified_final.csv',
    'enrichi_insee': DATA_PREP_OUTPUT_DIR / 'pharmacies_enrichies_insee.csv',
    'variables_touristiques': DATA_PREP_OUTPUT_DIR / 'pharmacies_final_avec_variables_touristiques.csv',
    'population_age_csv': DATA_INPUT_DIR / '2_insee_brutes' / 'age_profession.CSV',  # Donnees population + profession par IRIS
    'zones_iris_gpkg': DATA_INPUT_DIR / '1_sources_brutes' / 'contours_iris.gpkg',  # Zones IRIS
    'zones_iris_geojson': DATA_INPUT_DIR / 'zones_iris.geojson',  # Si disponible
    'sig_p20': DATA_INPUT_DIR / '5_validation' / 'SIG_P20.CSV',  # Données SIG P20 pour validation

    # Répertoires des isochrones (dans 1_data_prep/output/isochrones)
    'isochrones_walk_5min': DATA_PREP_OUTPUT_DIR / 'isochrones' / 'walk_5min',
    'isochrones_walk_10min': DATA_PREP_OUTPUT_DIR / 'isochrones' / 'walk_10min',
    'isochrones_drive_5min': DATA_PREP_OUTPUT_DIR / 'isochrones' / 'drive_5min',
    'isochrones_drive_10min': DATA_PREP_OUTPUT_DIR / 'isochrones' / 'drive_10min',
    'isochrones_drive_15min': DATA_PREP_OUTPUT_DIR / 'isochrones' / 'drive_15min',
    'isochrones_drive_20min': DATA_PREP_OUTPUT_DIR / 'isochrones' / 'drive_20min',
}
...
INTERMEDIATE_FILES = {
    'pharmacies_avec_hubs': DATA_INTERMEDIATE_DIR / '1_etapes_pipeline' / 'pharmacies_avec_hubs.csv',
    'pharmacies_avec_concurrence': DATA_INTERMEDIATE_DIR / '1_etapes_pipeline' / 'pharmacies_avec_concurrence.csv',
    'pharmacies_avec_population_isochrones': DATA_INTERMEDIATE_DIR / '1_etapes_pipeline' / 'pharmacies_avec_population_isochrones.csv',
    'pharmacies_features_complet': DATA_INTERMEDIATE_DIR / '1_etapes_pipeline' / 'pharmacies_features_complet.csv',  # Dataset complet
    'pharmacies_features_engineered': DATA_INTERMEDIATE_DIR / '1_etapes_pipeline' / 'pharmacies_features_engineered.csv',
    'pharmacies_features_selected': DATA_INTERMEDIATE_DIR / '1_etapes_pipeline' / 'pharmacies_features_selected.csv',
    'pharmacies_avec_scores_attractivite': DATA_INTERMEDIATE_DIR / '1_etapes_pipeline' / 'pharmacies_avec_scores_attractivite.csv',  # Généré par script 5
    'data_ml_complete': DATA_INTERMEDIATE_DIR / '1_etapes_pipeline' / 'data_ml_complete.csv',
    'data_ml_features': DATA_INTERMEDIATE_DIR / '1_etapes_pipeline' / 'data_ml_features.csv',

    # Fichiers spécifiques pour nettoyage matrice et modèle de Huff
    'matrice_pharmacie_iris_brute': DATA_PREP_OUTPUT_DIR / 'matrice_w_iris_100pct.csv',
    'matrice_pharmacie_iris_cleaned': DATA_PREP_OUTPUT_DIR / 'matrice_w_iris.csv',  # Généré par 1_data_prep/scripts/3_isochrones/c_calculate_w_iris.py
}
...
OUTPUT_FILES = {
    ...
    # Fichiers de sortie finaux Phase 2
    'pharmacies_clients_65plus_huff': DATA_INTERMEDIATE_DIR / '2_resultats_finaux' / 'pharmacies_clients_65plus_HUFF_EXACT_IRIS.csv',
    'correlation_hubs_medicaux': DATA_INTERMEDIATE_DIR / '3_analyses_correlations' / 'correlation_hubs_medicaux_complete.csv',
    'correlation_hubs_medicaux_graphs': DATA_INTERMEDIATE_DIR / '3_analyses_correlations' / 'correlation_hubs_medicaux_graphs.png',
    'summary_hubs_medicaux': DATA_INTERMEDIATE_DIR / '3_analyses_correlations' / 'summary_hubs_medicaux.csv',
}
...
POPULATION_CONFIG = {
    ...
    'colonne_zone': 'code_iris',  # Ou 'IRIS' selon votre fichier age_profession.CSV

    # Utiliser le fichier age_profession.CSV séparé ?
    'utiliser_fichier_population_separe': True,
    'fichier_population_separe': 'age_profession.CSV',  # Dans DATA_INPUT_DIR
}
