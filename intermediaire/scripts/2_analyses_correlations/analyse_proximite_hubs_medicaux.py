...
df_hubs = pd.read_csv(
    base_path / "data" / "output" / "HUBS_unified_final.csv",
    sep=';'
)
...
df_tourisme = pd.read_csv(
    base_path / "data" / "output" / "pharmacies_final_avec_variables_touristiques.csv"
)
...
try:
    ...
    graph_path = base_path / "intermediaire" / "output" / "correlation_hubs_medicaux_graphs.png"
...
output_path = base_path / "intermediaire" / "output" / "correlation_hubs_medicaux_complete.csv"
...
summary_path = base_path / "intermediaire" / "output" / "summary_hubs_medicaux.csv"
