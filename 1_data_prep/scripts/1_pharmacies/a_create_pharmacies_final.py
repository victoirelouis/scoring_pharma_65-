...
5. Exporter vers 1_data_prep/output/pharmacies_final.csv
...
from config_prep import OUTPUT_FILES, INPUT_FILES, LOG_FORMAT, LOG_LEVEL
...
CA_FILE = INPUT_FILES.get('pharmacies_source', Path(r"N:\Commun_GERS\Victoire LOUIS\PyScore\PROFILS DE PATIENTELE\Git\scoring_pharma_65-\1_data_prep\input\pharmacies.csv"))
OUTPUT_FILE = OUTPUT_FILES['pharmacies_final']
