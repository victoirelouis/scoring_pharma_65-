...
OUTPUT_DIR = BASE_DIR / "1_data_prep" / "output"

# Fichiers d'entrée
OSM_HUBS_FILE = OUTPUT_DIR / "hubs.csv"
FINESS_FILE = OUTPUT_DIR / "FINESS_merged.csv"
RPPS_FILE = OUTPUT_DIR / "rpps_geocode" / "RPPS_merged.csv"

# Fichier de sortie
OUTPUT_FILE = OUTPUT_DIR / "HUBS_unified.csv"
