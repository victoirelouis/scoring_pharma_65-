...
FINESS_MAPPING = {
    ...
    '500': {'type': 'ehpad', 'categorie': 'EHPAD', 'bonus': 0.25},
    '501': {'type': 'ehpad', 'categorie': 'Maison de retraite', 'bonus': 0.25},
    '502': {'type': 'ehpad', 'categorie': 'Résidence autonomie', 'bonus': 0.25},
    '460': {'type': 'ehpad', 'categorie': 'Résidence seniors', 'bonus': 0.25},
    
    # Hôpitaux et cliniques
    '355': {'type': 'hopital', 'categorie': 'CHU', 'bonus': 0.20},
    '362': {'type': 'hopital', 'categorie': 'CH', 'bonus': 0.20},
    '365': {'type': 'hopital', 'categorie': 'Clinique', 'bonus': 0.20},
    '370': {'type': 'hopital', 'categorie': 'Centre de santé', 'bonus': 0.20},
    '377': {'type': 'hopital', 'categorie': 'Hôpital militaire', 'bonus': 0.20},
    '378': {'type': 'hopital', 'categorie': 'Centre hospitalier spécialisé', 'bonus': 0.20},
    
    # Soins spécialisés
    '189': {'type': 'soin_specialise', 'categorie': 'Rééducation', 'bonus': 0.15},
    '192': {'type': 'soin_specialise', 'categorie': 'SSR', 'bonus': 0.15},
    '221': {'type': 'soin_specialise', 'categorie': 'Dialyse', 'bonus': 0.15},
    '286': {'type': 'soin_specialise', 'categorie': 'Oncologie', 'bonus': 0.15},
    '300': {'type': 'soin_specialise', 'categorie': 'Cabinet infirmier', 'bonus': 0.15},
    
    # Pharmacies et labos
    '620': {'type': 'pharmacie', 'categorie': 'Pharmacie', 'bonus': 0.00},
    '611': {'type': 'laboratoire', 'categorie': 'Laboratoire', 'bonus': 0.10},
}
                    ...
                    if pois is not None and len(pois) > 0:
                        ...
                        for idx, row in pois.iterrows():
                            ...
                            entry = {
                                ...
                                'bonus_attractivite': category_config['bonus'],
                                'source': 'OSM'
                            }
                            results.append(entry)
    ...
    try:
        ...
        for _, row in df_metro.iterrows():
            ...
            entry = {
                ...
                'bonus_attractivite': 0.08 if type_hub == 'metro' else 0.10,
                'source': 'RATP'
            }
            results.append(entry)
